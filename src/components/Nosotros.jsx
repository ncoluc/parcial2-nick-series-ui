      ...
      <Container id="nosotros" className="container-nosotros">
        <Row>
          <Col md={8}>
            ...
            <p>En Nick Series, nos apasiona el mundo de las series y queremos brindarte la mejor experiencia para descubrir y explorar nuevas series. Nuestra plataforma te permite buscar y filtrar series de acuerdo a tus preferencias, para que encuentres fácilmente lo que estás buscando.</p>
            <p>Con nuestro completo sistema de filtros, puedes seleccionar géneros específicos, el estado de la serie, así como también filtrar por fechas de estreno o finalización. Además, te ofrecemos la opción de ordenar los resultados por nombre o ranking, para que encuentres las mejores series según tus preferencias.</p>
          </Col>
          <Col md={4}>
        ...
        <Row>
          <p>En Nick Series, nos esforzamos por simplificar tu experiencia al mantener toda la información de las series en un solo lugar. Ya no tendrás que perder tiempo buscando información dispersa, aquí encontrarás todos los detalles que necesitas, incluyendo información sobre la plataforma de streaming en la que se encuentran disponibles las series.</p>
          ...
          <p>Únete a nosotros en Nick Series y forma parte de una comunidad apasionada por las series. Tu opinión cuenta y tu voz es importante. Juntos, haremos de Nick Series el destino definitivo para los amantes de las series de televisión.</p>
        </Row>
      </Container>
    </>
  );
